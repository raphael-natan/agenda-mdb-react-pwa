...
import {
    MDBBtn, MDBInput, MDBModal, MDBModalBody, MDBModalHeader, MDBModalFooter, MDBIcon, MDBContainer,
    MDBRow, MDBCol
} from "mdbreact"
    ...
    render() {
        return (
            <React.Fragment>
                ...
                {/* Modal code below: */}
                <MDBModal isOpen={this.state.modal}  toggle={this.toggleModal}>{/*toggle não funciona clicando fora modal*/}
                    <MDBModalHeader
