...
const App = () => {
    ...
    return (
        <React.Fragment>
            ...
            {/* Modal code below: */}
            <MDBModal isOpen={modal} /* NÃO FUNCIONA DEVIDO A TAG SER CLASS???*** toggle={toggleModal} */>
                <MDBModalHeader
        ...
        <React.Fragment>
            <div className="media mt-1">
                ...
                <div className="media-body mb-3 mb-lg-3">
                    <MDBBadge color="danger" className="ml-2 float-right" onClick={() => props.onDelete(id)}>-</MDBBadge>
